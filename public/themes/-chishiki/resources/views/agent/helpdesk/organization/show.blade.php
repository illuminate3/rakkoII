...
<?php  $org_hd = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel_panel\Organization::where('id','=',$orgs->id)->first();  ?>
<div id="alert-success" class="alert alert-success alert-dismissable" style="display:none;">
        ...
        <div class="col-md-8">
            ...
            <?php
                $user_orgs = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel_panel\User_org::where('org_id','=',$orgs->id)->paginate(5);
                ?>
...
<?php
$org_heads = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel_panel\User_org::where('org_id','=',$orgs->id)->get();
?>
