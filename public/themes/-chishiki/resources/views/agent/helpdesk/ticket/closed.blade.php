...
<?php
    ...
    if(Auth::user()->role == 'agent') {
        ...
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '>', 1)->where('dept_id','=',$dept->id)->where('status', '<', 4)->orderBy('id', 'DESC')->paginate(20);
    } else {
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '>', 1)->where('status', '<', 4)->orderBy('id', 'DESC')->paginate(20);
    }
?>
<!-- Main content -->
