...
<?php
    ...
    if(Auth::user()->role == 'agent') {
        ...
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '=', 5)->where('dept_id','=',$dept->id)->orderBy('id', 'DESC')->paginate(20);
    } else {
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '=', 5)->orderBy('id', 'DESC')->paginate(20);
    }
?>
<!-- Main content -->
