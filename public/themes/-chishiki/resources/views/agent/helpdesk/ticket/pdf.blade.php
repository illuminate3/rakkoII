...
<?php   $ticket_source = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_source::where('id','=',$tickets->source)->first();
        ...
        <?php $status = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Status::where('id', '=', $tickets->status)->first(); ?>
        <?php $priority = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::where('priority_id', '=', $tickets->priority_id)->first(); ?>
        <?php $help_topic = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::where('id', '=', $tickets->help_topic_id)->first(); ?>
        <?php $help_topic = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::where('id', '=', $tickets->help_topic_id)->first(); ?>
<?php $dept = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::where('id','=',$help_topic->department)->first();   ?>
        <table class="table">    
            <tr><th></th><th></th></tr>
        ...
        <?php $conversations = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id', '=', $tickets->id)->get(); ?>
