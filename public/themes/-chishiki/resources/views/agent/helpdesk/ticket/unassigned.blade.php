...
<?php
    ...
    if(Auth::user()->role == 'agent') {
        ...
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('assigned_to', '=', null)->where('dept_id','=',$dept->id)->where('status','1')->orderBy('id', 'DESC')->paginate(20);
    } else {
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('assigned_to', '=', null)->where('status','1')->orderBy('id', 'DESC')->paginate(20);
    }
    // dd($tickets);
?>
<!-- Main content -->
<div class="box box-info">
    <div class="box-header with-border">
        <?php $counted = count(App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('assigned_to', '=', 0)->get());?>
