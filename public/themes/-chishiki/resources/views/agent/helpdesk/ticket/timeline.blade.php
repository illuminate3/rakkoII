...
<?php
    ...
    $group = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Groups::where('id', '=', $agent_group)->where('group_status', '=', '1')->first();
?>
...
<?php
            Event::fire(new \App\Modules\Chishiki\Events\TicketBoxHeader($user->id));
    ...
    <div id="alert13" class="alert alert-danger alert-dismissable" style="display:none;">
        ...
        <div class="row">
            <section class="content"  >
                <div class="col-md-12">
                    <?php
$priority = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::where('priority_id', '=', $tickets->priority_id)->first();
?>
                    <div class="callout callout-{{$priority->priority_color}}">
                        <div class="row">
                            <div class="col-md-3">
                                <?php
$sla = $tickets->sla;
$SlaPlan = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Sla_plan::where('id', '=', $sla)->first();
?>
...
?>
                            ...
                            <div class="col-md-3">
                                <?php $response = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id', '=', $tickets->id)->get();?>
                ...
                <div class="col-md-6">
                    <table class="table table-hover">
                        <div id="refresh">
                            <tr><td><b>{!! Lang::get('lang.status') !!}:</b></td>       <?php $status = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Status::where('id', '=', $tickets->status)->first();?><td title="{{$status->properties}}">{{$status->name}}</td></tr>
                            <tr><td><b>{!! Lang::get('lang.priority') !!}:</b></td>     <?php $priority = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::where('priority_id', '=', $tickets->priority_id)->first();?><td title="{{$priority->priority_desc}}">{{$priority->priority_desc}}</td></tr>
                            <tr><td><b>{!! Lang::get('lang.department') !!}:</b></td>   <?php $dept123 = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::where('id', '=', $tickets->dept_id)->first();?><td title="{{$dept123->name}}">{{$dept123->name}}</td></tr>
...
<?php 
    ...
    $TicketData = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id', '=', $thread->ticket_id)->max('id');
                        $TicketDatarow = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('id', '=', $TicketData)->first();
                        ...
                        if($tickets->source > 0)
                        {
                            $ticket_source = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_source::where('id','=',$tickets->source)->first();
...
?>
                    <table class="table table-hover">
                        <div id="refresh3">
                            ...
                            <tr><td><b>{!! Lang::get('lang.help_topic') !!}:</b></td>     <?php $help_topic = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::where('id', '=', $tickets->help_topic_id)->first();?><td title="{{$help_topic->topic}}">{{$help_topic->topic}}</td></tr>
                            <?php Event::fire(new App\Modules\Chishiki\Events\TicketDetailTable($TicketData)); ?>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="General">
                    ...
                    <div id="t1">
                                ...
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <div id="refreshTo">
                                            ...
                                            <div id="recepients">
                                            <?php $Collaborator =  App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Collaborator::where('ticket_id', '=', $tickets->id)->get(); 
                        ...
                        <?php Event::fire(new App\Modules\Chishiki\Events\TimeLineFormEvent($TicketData)); ?>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-2">
...
<?php 
$canneds = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel_panel\Canned::where('user_id','=',Auth::user()->id)->get();
?>                                                  
...
<?php
$conversations = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id', '=', $tickets->id)->orderBy('id', 'DESC')->paginate(10);
$ij = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id', '=', $tickets->id)->first();
...
$data = $ConvDate[0];
    ...
    <?php } }
    $attachment = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_attachments::where('thread_id','=',$conversation->id)->first();
    if($attachment == null ) {
        ...
        $body = $conversation->body;
        $attachments = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_attachments::where('thread_id','=',$conversation->id)->orderBy('id', 'DESC')->get();
        // $i = 0;
    ...
    ?>
                                <div class="timeline-item">
                                    ...
                                    <?php  $ticket_form_datas = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Form_Data::where('ticket_id', '=', $tickets->id)->get();  ?>
                                    ...
                                    @if(!$conversation->is_internal)
                                    <?php Event::fire(new App\Modules\Chishiki\Events\Timeline($conversation,$role,$user)); ?>
                                    @endif
                                        <?php 
                                        $attachments = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_attachments::where('thread_id','=',$conversation->id)->get();
                                        $i = 0;
                                        foreach($attachments as $attachment) {
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $sla_plans = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Sla_plan::all() ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $help_topics = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::all() ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $ticket_sources = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_source::all() ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php $ticket_prioritys = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::all() ?>
...
$teams = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Teams::all();
                        ...
                        <div id="merge-body-form">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label>{!! Lang::get('lang.title') !!}</label>
                                    <input type="text" name='title' class="form-control" value="<?php $ticket_data = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::select('title')->where('ticket_id', "=", $tickets->id)->first();    echo $ticket_data->title;?>"/>
                                </div>
                                <div class="col-md-6">
                                <label>{!! Lang::get('lang.select-pparent-ticket') !!}</label>
                                    ...
                                    <div id="parent-body" >
                                        ...
                                        <select class="form-control" id="select-merge-parent"  name='p_id' data-placeholder="{!! Lang::get('lang.select_tickets') !!}" style="width: 100%;"><option value="{{$tickets->id}}"><?php $ticket_data = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::select('title')->where('ticket_id', "=", $tickets->id)->first();    echo $ticket_data->title;?></option></select>
                                    </div>
                                </div>
                            </div>
...
<?php  $var=App\Modules\Chishiki\Http\Models\helpdesk\Settings\Ticket::where('id', '=', 1)->first(); ?>
...
$(document).ready(function() {
    ...
    function parentAjaxCall(){
       // alert();
        ...
        if(arr == null) {
            document.getElementById("select-merge-parent").innerHTML = "<option value='{{$tickets->id}}'><?php $ticket_data = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::select('title')->where('ticket_id', "=", $tickets->id)->first();    echo $ticket_data->title;?></option>"
        } else {
            $.ajax({
                type: "GET",
