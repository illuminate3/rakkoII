...
<?php
    ...
    if(Auth::user()->role == 'agent')
    {
        ...
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '=', 1)->where('isanswered', '=', 1)->where('dept_id','=',$dept->id)->orderBy('id', 'DESC')->paginate(20);
    } else {
        $tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '=', 1)->where('isanswered', '=', 1)->orderBy('id', 'DESC')->paginate(20);
    }   
?>
<!-- Main content -->
