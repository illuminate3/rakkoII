                    ...
                    <table class="row">
                        ...
                        <tr><th class="col-md-8"><h4><b>{!! Lang::get('lang.gender') !!}:<b></h4></th><td class="col-md-6"><h4>{{ 'Male' }}</h4></td></tr>
                                    ...
                                    if ($user->assign_group) {
                                        $grp = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Groups::where('id', '=', $user->assign_group)->first();
                                        $grp = $grp->name;
                                    } else {
                                        $grp = "";
                                    }
                                    if ($user->agent_tzone) {
                                        $timezone = App\Modules\Chishiki\Http\Models\helpdesk\Utility\Timezones::where('id', '=', $user->agent_tzone)->first();
