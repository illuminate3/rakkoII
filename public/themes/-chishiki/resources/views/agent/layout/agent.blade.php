...
<?php
$company = App\Modules\Chishiki\Http\Models\helpdesk\Settings\Company::where('id', '=', '1')->first();
if ($company != null) {
}
?>
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <?php $notifications = App\Modules\Chishiki\Http\Controllers\Common\NotificationController::getNotifications();
                    ?>
...
<?php
if(Auth::user()->role == 'admin') {
//$inbox = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::all();
$myticket = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('assigned_to', Auth::user()->id)->where('status','1')->get();
$unassigned = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('assigned_to', '=',null)->where('status', '=', '1')->get();
$tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status','1')->get();
$deleted = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '5')->get();
} elseif(Auth::user()->role == 'agent') {
//$inbox = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('dept_id','',Auth::user()->primary_dpt)->get();
$myticket = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('assigned_to', Auth::user()->id)->where('status','1')->get();
$unassigned = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('assigned_to', '=',null)->where('status', '=', '1')->where('dept_id','=',Auth::user()->primary_dpt)->get();
$tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status','1')->where('dept_id','=',Auth::user()->primary_dpt)->get();
$deleted = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '5')->where('dept_id','=',Auth::user())->get();
}
if (Auth::user()->role == 'agent') {
            $dept = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::where('id', '=', Auth::user()->primary_dpt)->first();
            $overdues = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '=', 1)->where('isanswered', '=', 0)->where('dept_id', '=', $dept->id)->orderBy('id', 'DESC')->get();
        } else {
            $overdues = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status', '=', 1)->where('isanswered', '=', 0)->orderBy('id', 'DESC')->get();
        }
$i = count($overdues);
if ($i == 0) {
            $overdue_ticket = 0;
            ...
            foreach ($overdues as $overdue) {
                $sla_plan = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Sla_plan::where('id', '=', $overdue->sla)->first();
...
<?php
$depts = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::all();
foreach ($depts as $dept) {
$open = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status','=','1')->where('isanswered', '=', 0)->where('dept_id','=',$dept->id)->get();
$open = count($open);
$underprocess = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status','=','1')->where('assigned_to','>', 0)->where('dept_id','=',$dept->id)->get();
$underprocess = count($underprocess);
$closed = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('status','=','2')->where('dept_id','=',$dept->id)->get();
$closed = count($closed);
    // $underprocess = 0;
