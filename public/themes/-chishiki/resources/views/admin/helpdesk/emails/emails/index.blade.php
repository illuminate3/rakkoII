...
@if(Session::has('success'))
    ...
    <?php
    $default_system_email = App\Modules\Chishiki\Http\Models\helpdesk\Settings\Email::where('id', '=', '1')->first();
	...
	<tr>
						...
						<tr>
							...
							<?php $priority = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::where('priority_id','=',$email->priority)->first(); ?>
							...
							@if($email->department !== null)
								<?php  $department = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::where('id','=',$email->department)->first(); 
