                                        ...
                                        <tr id="seconddata{!! $i !!}">
                                            ...
                                            <td id="fill{!! $i !!}">
                                                ...
                                                if($workflow_action->condition == 'reject')
                                                {
                                                    ...
                                                    $departments = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::all();
                                                    ...
                                                    $priorities = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::all();
                                                    $var = "<select name='action[". $i ."][b]' class='form-control' required>";
                                                    ...
                                                    $sla_plans = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Sla_plan::where('status', '=', 1)->get();
                                                    $var = "<select name='action[". $i ."][b]' class='form-control' required>";
                                                    ...
                                                    $teams = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Teams::where('status', '=', 1)->get();
                                                    $var = "<select name='action[". $i ."][b]' class='form-control' required>";
                                                    ...
                                                    $help_topics = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::where('status', '=', 1)->get();
                                                    $var = "<select name='action[". $i ."][b]' class='form-control' required>";
                                                    ...
                                                    $ticket_status = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Status::all();
                                                    $var = "<select name='action[". $i ."][b]' class='form-control' required>";
