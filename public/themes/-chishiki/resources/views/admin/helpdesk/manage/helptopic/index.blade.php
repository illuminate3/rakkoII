...
@if(Session::has('success'))
	...
	$default_helptopic = App\Modules\Chishiki\Http\Models\helpdesk\Settings\Ticket::where('id','=','1')->first();
	...
	<tr style="padding-bottom:-30px">
		...
		<!-- Priority -->
<?php $priority = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::where('priority_id','=',$topic->priority)->first(); ?>
		<td>{!! $priority->priority_desc !!}</td>
		<!-- Department -->
		@if($topic->department != null)
			<?php $dept = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::where('id', '=', $topic->department)->first(); 
			$dept = $dept->name; ?>
