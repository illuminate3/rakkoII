...
<div class="box">
   ...
   <?php $id = App\Modules\Chishiki\Http\Models\helpdesk\Form\Forms::where('id',$id)->first(); ?>
...
<?php
    $i=$id->id;
    $values = App\Modules\Chishiki\Http\Models\helpdesk\Form\Fields::where('forms_id', '=', $i)->get();    
