...
<?php
$group = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Groups::whereId($use->assign_group)->first();
$department = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::whereId($use->primary_dpt)->first();
?>
