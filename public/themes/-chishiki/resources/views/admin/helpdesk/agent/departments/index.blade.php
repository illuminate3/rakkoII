...
<?php
$default_department = App\Modules\Chishiki\Http\Models\helpdesk\Settings\System::where('id','=','1')->first();
						...
						<tr>
							...
							<td>
								...
								if($department->sla == null){
									...
									$sla = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Sla_plan::whereId($department->sla)->first();
