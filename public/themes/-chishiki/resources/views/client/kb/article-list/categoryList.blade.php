...
<div class="row separator">
    ...
    <div class="col-xs-6">
        ...
        <?php
        $all = App\Modules\Chishiki\Http\Models\kb\Relationship::where('category_id', $category->id)->get();
//dd($all);
...
<?php foreach ($article_id as $id) {
    ?>
                    <?php
                    $article = App\Modules\Chishiki\Http\Models\kb\Article::where('id', $id)->get();
                    ...
                    <li class="article-entry image" style="margin-left: 50px;">
                        ...
                        <span class="article-meta">{{$arti->created_at->format('l, d-m-Y')}}
                            ...
                            <?php $excerpt = App\Modules\Chishiki\Http\Controllers\Client\kb\UserController::getExcerpt($str, $startPos = 0, $maxLength = 55) ?>
