...
@section('kb')
    class = "active"
@stop
<?php  $category = App\Modules\Chishiki\Http\Models\kb\Category::where('id','=',$id)->first(); ?>
@section('breadcrumb')
...
<div id="content" class="site-content col-md-9">
    ...
    <div class="archive-list archive-article">
        <?php foreach ($article_id as $id) { ?>
            <?php $article = App\Modules\Chishiki\Http\Models\kb\Article::where('id', $id)->orderBy('created_at', 'ASC')->get(); ?>
            ...
            <article class="hentry">
                ...
                <?php $excerpt = App\Modules\Chishiki\Http\Controllers\Client\kb\UserController::getExcerpt($str, $startPos = 0, $maxLength = 400); ?>
