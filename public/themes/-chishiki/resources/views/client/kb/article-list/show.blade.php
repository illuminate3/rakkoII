...
<?php
//dd($arti);
$all = App\Modules\Chishiki\Http\Models\kb\Relationship::where('article_id','=', $arti->id)->get();
//dd($all);
...
<div class="site-hero clearfix">
    <ol class="breadcrumb breadcrumb-custom">
        ...
        <?php $category = App\Modules\Chishiki\Http\Models\kb\Category::where('id', $category_id)->first(); ?>
...
<div id="content" class="site-content col-md-9">
    ...
    <?php $comments = App\Modules\Chishiki\Http\Models\kb\Comment::where('article_id', $arti->id)->where('status', '1')->get(); ?>
...
<?php $categorys = App\Modules\Chishiki\Http\Models\kb\Category::all(); ?>
