...
@section('content')               
<?php  
$tickets = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('id','=',\Crypt::decrypt($id))->first(); 
$thread = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id','=',\Crypt::decrypt($id))->first();
                                ...
                                <section class="content"  id="refresh" style="margin-bottom:-10px;margin-top:-10px">
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="callout callout-default ">
                                            <div class="row">
                                                ...
                                                <?php
                                                $sla = $tickets->sla;
                                                $SlaPlan = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Sla_plan::where('id','=',1)->first();?>
                                                ...
                                                <div class="col-md-3">
                                                <?php $response = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id','=',$tickets->id)->where('is_internal','=',0)->get();?>
                                    ...
                                    <div class="col-md-6"> 
                                        <table class="table table-hover">
                                            <!-- <tr><th></th><th></th></tr> -->
                                            <tr><td><b>{!! Lang::get('lang.status') !!}:</b></td>       <?php $status = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Status::where('id','=',$tickets->status)->first();?>
                                            ...
                                            <tr><td><b>{!! Lang::get('lang.priority') !!}:</b></td>     <?php $priority = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority::where('priority_id','=',$tickets->priority_id)->first();?>
                                        ...
                                        <?php 
                                        $help_topic = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::where('id','=',$tickets->help_topic_id)->first();
                                        $department = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::where('id', '=', $help_topic->department)->first();
                                        ?>
...
<?php
$conversations = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id', '=', $tickets->id)->where('is_internal', '=', 0)->paginate(10);
