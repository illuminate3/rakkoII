...
<?php
$open = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('user_id', '=' , Auth::user()->id)
                ->where('status', '=', 1)
                ->orderBy('id', 'DESC')
                ->paginate(20);
?>
...
<?php
$close = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('user_id', '=' , Auth::user()->id)
                ->whereIn('status', [2, 3]) 
                ->orderBy('id', 'DESC')
                ->paginate(20);
?>
...
?> >
                        ...
                        <?php $title = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread::where('ticket_id', '=', $ticket->id)->first();
                ...
                <?php $status = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Status::where('id', '=', $ticket->status)->first(); ?>
