...
<?php 
$forms = App\Modules\Chishiki\Http\Models\helpdesk\Form\Forms::get(); 
$helptopic = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::get();
?>                  
            <select name="helptopic" class="form-control" id="selectid">
            <?php  
            $system_default_department = App\Modules\Chishiki\Http\Models\helpdesk\Settings\System::where('id','=',1)->first();
            if($system_default_department->department) {
                $department_relation_helptopic = App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic::where('department','=',$system_default_department->department)->first();
        ...
        {{-- Event fire --}}
        <?php Event::fire(new App\Modules\Chishiki\Events\ClientTicketForm()); ?>
