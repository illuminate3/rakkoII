...
<html>
    <head>
        <meta charset="UTF-8">
        <?php  
        $title = App\Modules\Chishiki\Http\Models\helpdesk\Settings\System::where('id','=','1')->first();
        if(isset($title->name)){
	...
	<div id="page" class="hfeed site">
            <header id="masthead" class="site-header" role="banner">
				...
				$system = App\Modules\Chishiki\Http\Models\helpdesk\Settings\System::where('id', '=', '1')->first();
				?>
				@if($system->url)
