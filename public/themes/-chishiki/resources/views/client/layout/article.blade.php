            ...
            <header id="masthead" class="site-header" role="banner">
                <div class="container">
                    <div id="logo" class="site-logo text-center" style="font-size: 40px">
                        <a href="{{url('/')}}" rel="home"><?php $company = App\Modules\Chishiki\Http\Models\kb\Settings::where('id', '=', '1')->first(); ?>
                            @if($company->logo)
                    ...
                    <div id="navbar" class="navbar-wrapper text-center">
                        <nav class="navbar navbar-default site-navigation" role="navigation">
                            ...
                            <ul class="nav navbar-nav navbar-menu">
                                ...
                                <?php $pages = App\Modules\Chishiki\Http\Models\kb\Page::where('status', '1')->where('visibility', '1')->get();
                                ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-about" class="section">
                                    <?php $footer = App\Modules\Chishiki\Http\Models\kb\Footer::whereId('1')->first(); ?>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-latest-news" class="section">
                                    <?php $footer2 = App\Modules\Chishiki\Http\Models\kb\Footer2::whereId('1')->first(); ?>
                                    @if($footer2->title)
                                    <h2 class="section-title h4 clearfix">{{$footer2->title}}</h2>
                                    <p>{!!$footer2->footer!!}</p>	
                                    @else
                                    <h2 class="section-title h4 clearfix">Categories</h2>
                                    <?php $categorys = App\Modules\Chishiki\Http\Models\kb\Category::get(); ?>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-newsletter" class="section">
                                    <?php $footer3 = App\Modules\Chishiki\Http\Models\kb\Footer3::whereId('1')->first(); ?>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-newsletter" class="section">
                                    <?php $footer4 = App\Modules\Chishiki\Http\Models\kb\Footer4::whereId('1')->first(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="site-social text-right col-md-6">
                            <?php $social = App\Modules\Chishiki\Http\Models\kb\Social::where('id', '1')->first(); ?>
