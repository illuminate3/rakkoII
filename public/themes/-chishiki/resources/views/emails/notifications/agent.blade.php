...
$dept = App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department::where('id','=',$user->primary_dpt)->first();
   ...
   $inprogress = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('dept_id','=',$dept->id)->where('status', '=', 1)->count();
   $overdues = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('dept_id','=',$dept->id)->where('status', '=', 1)->get();
   $i = 0;
