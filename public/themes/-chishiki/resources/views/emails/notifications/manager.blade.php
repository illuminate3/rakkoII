...
$inprogress = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('dept_id','=',$dept_id)->where('status', '=', 1)->count();

$overdues = App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets::where('dept_id','=',$dept_id)->where('status', '=', 1)->get();
