...
// controller
use App\Modules\Chishiki\Http\Controllers\Agent\helpdesk\TicketController;
use App\Modules\Chishiki\Http\Controllers\Controller;
// request
use App\Modules\Chishiki\Http\Requests\helpdesk\WorkflowCreateRequest;
use App\Modules\Chishiki\Http\Requests\helpdesk\WorkflowUpdateRequest;
...
use App\Modules\Chishiki\Http\Models\helpdesk\Workflow\WorkflowAction;
use App\Modules\Chishiki\Http\Models\helpdesk\Workflow\WorkflowName;
use App\Modules\Chishiki\Http\Models\helpdesk\Workflow\WorkflowRules;
use App\User;
use Datatable;
//classes
use Exception;
...
//        dd($emails->lists('email_address' , 'id'));
     ...
     *
     * @param \App\Modules\Chishiki\Http\Requests\helpdesk\WorkflowCreateRequest $request
     *
     * @return type view
     */
     ...
     *
     * @param type                                              $id
     * @param \App\Modules\Chishiki\Http\Requests\helpdesk\WorkflowUpdateRequest $request
     *
     * @return type view
     */
