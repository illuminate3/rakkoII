...
namespace App\Modules\Chishiki\Http\Controllers\Agent\helpdesk;

// controllers
use App\Modules\Chishiki\Http\Controllers\Common\NotificationController;
use App\Modules\Chishiki\Http\Controllers\Common\PhpMailController;
use App\Modules\Chishiki\Http\Controllers\Controller;
// requests
use App\Modules\Chishiki\Http\Requests\helpdesk\CreateTicketRequest;
use App\Modules\Chishiki\Http\Requests\helpdesk\TicketRequest;
// models
use App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Department;
use App\Modules\Chishiki\Http\Models\helpdesk\Agent_panel\Teams;
use App\Modules\Chishiki\Http\Models\helpdesk\Email\Emails;
use App\Modules\Chishiki\Http\Models\helpdesk\Form\Fields;
use App\Modules\Chishiki\Http\Models\helpdesk\Manage\Help_topic;
use App\Modules\Chishiki\Http\Models\helpdesk\Manage\Sla_plan;
use App\Modules\Chishiki\Http\Models\helpdesk\Settings\Alert;
use App\Modules\Chishiki\Http\Models\helpdesk\Settings\Company;
use App\Modules\Chishiki\Http\Models\helpdesk\Settings\Email;
use App\Modules\Chishiki\Http\Models\helpdesk\Settings\System;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_attachments;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Collaborator;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Form_Data;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Priority;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_source;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Status;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Ticket_Thread;
use App\Modules\Chishiki\Http\Models\helpdesk\Ticket\Tickets;
use App\Modules\Chishiki\Http\Models\helpdesk\Utility\Date_time_format;
use App\Modules\Chishiki\Http\Models\helpdesk\Utility\Timezones;
use App\User;
use Auth;
use DB;
use Exception;
...
class TicketController extends Controller
{
    ...
    public function reply(Ticket_Thread $thread, TicketRequest $request, Ticket_attachments $ta)
    {
        ...
        \Event::fire(new \App\Modules\Chishiki\Events\ClientTicketFormPost($form_data, $emailadd, $source));
        ...
        // Event
        \Event::fire(new \App\Modules\Chishiki\Events\FaveoAfterReply($reply_content, $user->phone_number, $request, $tickets));
    ...
    public function create_user($emailadd, $username, $subject, $body, $phone, $helptopic, $sla, $priority, $source, $headers, $dept, $assignto, $from_data, $auto_response, $status)
    {
        ...
        if ($checkemail == false) {
            ...
            \Event::fire(new \App\Modules\Chishiki\Events\ClientTicketFormPost($from_data, $emailadd, $source));
            if ($user->save()) {
                $user_id = $user->id;
                // Event fire
                \Event::fire(new \App\Modules\Chishiki\Events\ReadMailEvent($user_id, $password));
                try {
                    if ($auto_response == 0) {
