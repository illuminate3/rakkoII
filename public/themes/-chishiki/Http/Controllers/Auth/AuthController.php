...
namespace App\Modules\Chishiki\Http\Controllers\Auth;
...
// requests
use App\Modules\Chishiki\Http\Requests\helpdesk\LoginRequest;
use App\Modules\Chishiki\Http\Requests\helpdesk\RegisterRequest;
use App\User;
// classes
use Auth;
use Hash;
...
class AuthController extends Controller
{
    ...
    {
        // Event for login
        \Event::fire(new \App\Modules\Chishiki\Events\FormRegisterEvent());
        if (Auth::user()) {
    ...
    {
        // Event for login
        \Event::fire(new \App\Modules\Chishiki\Events\LoginEvent($request));
