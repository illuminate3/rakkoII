...
namespace App\Modules\Chishiki\Http\Controllers\Installer\helpdesk;

// controllers
use App\Modules\Chishiki\Http\Controllers\Controller;
// requests
use App\Modules\Chishiki\Http\Requests\helpdesk\DatabaseRequest;
use App\Modules\Chishiki\Http\Requests\helpdesk\InstallerRequest;
// models
...
class InstallController extends Controller
{
    ...
    public function finalize()
    {
        ...
        if (Session::get('step6') == 'step6') {
            ...
            $smtpfilepath = "\App\Modules\Chishiki\Http\Controllers\Common\SettingsController::smtp()";
            $lfmpath = "url('photos').'/'";
