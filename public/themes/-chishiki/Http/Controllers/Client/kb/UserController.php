...
namespace App\Modules\Chishiki\Http\Controllers\Client\kb;

use App\Modules\Chishiki\Http\Controllers\Controller;
use App\Modules\Chishiki\Http\Requests\kb\CommentRequest;
use App\Modules\Chishiki\Http\Requests\kb\ContactRequest;
use App\Modules\Chishiki\Http\Requests\kb\ProfilePassword;
use App\Modules\Chishiki\Http\Requests\kb\SearchRequest;
use App\Modules\Chishiki\Http\Models\kb\Article;
use App\Modules\Chishiki\Http\Models\kb\Category;
use App\Modules\Chishiki\Http\Models\kb\Comment;
use App\Modules\Chishiki\Http\Models\kb\Contact;
use App\Modules\Chishiki\Http\Models\kb\Faq;
use App\Modules\Chishiki\Http\Models\kb\Page;
use App\Modules\Chishiki\Http\Models\kb\Relationship;
...
class UserController extends Controller
{
    ...
    public function show($slug, Article $article, Category $category)
    {
        ...
        $tz = \App\Modules\Chishiki\Http\Models\helpdesk\Settings\System::where('id', '1')->first()->time_zone;
        $tz = \App\Modules\Chishiki\Http\Models\helpdesk\Utility\Timezones::where('id', $tz)->first()->name;
