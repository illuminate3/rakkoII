...
-->
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('themes/' . $activeTheme . '/assets/mega/css/style.css') }}">
...
<header>
	@include($activeTheme . '::' . '_partials.mega.navigation')
</header>
...
<!-- ------------------------------------------ js ------------------------------------------ -->
	...
	<script type="text/javascript" src="{{ asset('themes/' . $activeTheme . '/assets/mega/js/main.js') }}"></script>
