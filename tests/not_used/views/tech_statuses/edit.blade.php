...
{{-- Web site Title --}}
@section('title')
{{ Lang::choice('kotoba::shop.tech_status', 2) }} :: @parent
@stop
...
<h1>
	<p class="pull-right">
	<a href="/admin/tech_statuses" class="btn btn-default" title="{{ trans('kotoba::button.back') }}">
...
{!! Form::model(
	$status,
	[
		'route' => ['admin.tech_statuses.update', $status->id],
		'method' => 'PATCH',
		'class' => 'form'
	]
) !!}
...
<div class="row">
<div class="col-sm-4">
	<a href="/admin/tech_statuses" class="btn btn-default btn-block" title="{{ trans('kotoba::button.cancel') }}">
