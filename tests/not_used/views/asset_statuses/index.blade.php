...
oTable =
	$('#table').DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "{{ URL::to('admin/api/asset_statuses') }}",
		"columns": [
			{data: 'id', name: 'id'},
			{data: 'name', name: 'name'},
...
<h1>
	<p class="pull-right">
	<a href="/admin/asset_statuses/create" class="btn btn-primary" title="{{ trans('kotoba::button.new') }}">
		<i class="fa fa-plus fa-fw"></i>
		{{ trans('kotoba::button.new') }}
	</a>
	</p>
	<i class="fa fa-angle-double-right fa-lg"></i>
		{{ Lang::choice('kotoba::shop.asset_status', 2) }}
	<hr>
</h1>
</div>
