...
<h1>
	<p class="pull-right">
	<a href="/admin/asset_statuses" class="btn btn-default" title="{{ trans('kotoba::button.back') }}">
...
{!! Form::model(
	$status,
	[
		'route' => ['admin.asset_statuses.update', $status->id],
		'method' => 'PATCH',
		'class' => 'form'
	]
) !!}
...
<div class="row">
<div class="col-sm-4">
	<a href="/admin/asset_statuses" class="btn btn-default btn-block" title="{{ trans('kotoba::button.cancel') }}">
