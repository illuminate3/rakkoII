...
$inprogress = App\Modules\Support\Http\Models\HelpDesk\Ticket\Tickets::where('dept_id','=',$dept_id)->where('status', '=', 1)->count();

$overdues = App\Modules\Support\Http\Models\HelpDesk\Ticket\Tickets::where('dept_id','=',$dept_id)->where('status', '=', 1)->get();
