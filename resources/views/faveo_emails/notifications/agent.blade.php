...
$dept = App\Modules\Support\Http\Models\HelpDesk\Agent\Department::where('id','=',$user->primary_dpt)->first();
   ...
   $inprogress = App\Modules\Support\Http\Models\HelpDesk\Ticket\Tickets::where('dept_id','=',$dept->id)->where('status', '=', 1)->count();
   $overdues = App\Modules\Support\Http\Models\HelpDesk\Ticket\Tickets::where('dept_id','=',$dept->id)->where('status', '=', 1)->get();
   $i = 0;
