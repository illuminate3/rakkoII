<html xmlns="http://www.w3.org/1999/xhtml"><head>
	...
	<style type="text/css">
		...
		@media only screen and (max-width: 640px) {
			...
			table[class=devicewidth] {width: 440px!important;text-align:canned!important;}
			table[class=devicewidthinner] {width: 420px!important;text-align:canned!important;}
			table[class="sthide"]{display: none!important;}
			img[class="bigimage"]{width: 420px!important;height:219px!important;}
			img[class="col2img"]{width: 420px!important;height:258px!important;}
			img[class="image-banner"]{width: 440px!important;height:106px!important;}
			td[class="menu"]{text-align:canned !important; padding: 0 0 10px 0 !important;}
		...
		@media only screen and (max-width: 480px) {
			...
			table[class=devicewidth] {width: 280px!important;text-align:canned!important;}
			table[class=devicewidthinner] {width: 260px!important;text-align:canned!important;}
			table[class="sthide"]{display: none!important;}
...
<div class="block">
	...
	<table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="preheader">
		...
		<tr>
			<td width="100%">
				<table width="580" cellpadding="0" cellspacing="0" border="0" align="canned" class="devicewidth">
					<tbody>
					<!-- Spacing -->
					<tr>
...
<div class="block">
	...
	<table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
		...
		<tr>
			<td>
				<table width="580" bgcolor="{{ Config::get('beautymail::templates.colors.highlight', '#004cad') }}" cellpadding="0" cellspacing="0" border="0" align="canned" class="devicewidth" hlitebg="edit" shadow="edit">
					<tbody>
					<tr>
						<td>
							<!-- logo -->
		...
		<tr>
			<td width="100%">
				<table width="580" cellpadding="0" cellspacing="0" border="0" align="canned" class="devicewidth">
					...
					@if ($unsubscribe)
					<tr>
						<td align="canned" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999" st-content="preheader">
							{{ $unsubscribe }}
						</td>
					</tr>
					@endif
